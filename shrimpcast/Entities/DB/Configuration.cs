                    ...
                    values = new object[]
                    {
                        ...
                        new
                        {
                            ...
                            fields = new[]
                            {
                                ...
                                new { name = nameof(Source.Name).NormalizeToJavascript(), label = "Name", type = Constants.AddTableItem.text, color = "primary" },
                                ...
                                new { name = nameof(Source.UseLegacyPlayer).NormalizeToJavascript(), label = "Native player", type = Constants.AddTableItem.boolean, color = "secondary" },
                                new { name = nameof(Source.UseRTCEmbed).NormalizeToJavascript(), label = "Embed", type = Constants.AddTableItem.boolean, color = "secondary" },
                                new { name = nameof(Source.WithCredentials).NormalizeToJavascript(), label = "With credentials", type = Constants.AddTableItem.boolean, color = "secondary" },
                                new { name = nameof(Source.ResetOnScheduledSwitch).NormalizeToJavascript(), label = "Reset on start", type = Constants.AddTableItem.boolean, color = "secondary"  },
