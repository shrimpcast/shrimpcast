...
namespace shrimpcast.Migrations
{
    ...
    [Migration("20260820034532_RemoveUrlNativePlayerEmbedAddLbSettingsStreamOverride")]
    partial class RemoveUrlNativePlayerEmbedAddLbSettingsStreamOverride
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("shrimpcast.Entities.DB.Configuration", b =>
                {
                    ...
                    b.Property<string>("LbAuthToken")
                        .HasColumnType("text");

                    b.Property<bool>("LbSendInstanceMetrics")
                        .HasColumnType("boolean");

                    b.Property<string>("LbTargetDomain")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("ShowUserLabels")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("shrimpcast.Entities.DB.MediaServerStream", b =>
                {
                    ...
                    b.Property<int>("AudioAACBitrate")
                        .HasColumnType("integer");

                    b.Property<string>("AudioCustomSource")
                        .HasColumnType("text");

                    b.Property<bool>("AudioCustomSourceProbeForceHLS")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("CustomAudioHeaders")
                        .HasColumnType("text");
                    ...
                    b.Property<bool>("IsPlaylist")
                        .HasColumnType("boolean");

                    b.Property<int>("ListSize")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("VideoEncodingPreset")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<int>("VideoStreamIndex")
                        .HasColumnType("integer");

                    b.Property<bool>("VideoStreamProbeForceHLS")
                        .HasColumnType("boolean");

                    b.Property<int>("VideoTranscodingBitrate")
                        .HasColumnType("integer");

                    b.Property<int>("VideoTranscodingFramerate")
                        .HasColumnType("integer");

                    b.Property<string>("VideoTranscodingPreset")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("shrimpcast.Entities.DB.Session", b =>
                {
                    ...
                    b.Property<int?>("MutedBySessionId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("shrimpcast.Entities.DB.Source", b =>
                {
                    ...
                    b.Property<string>("StreamOverride")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("shrimpcast.Entities.DB.Session", b =>
                {
                    b.HasOne("shrimpcast.Entities.DB.Session", "MutedBySession")
                        .WithMany()
                        .HasForeignKey("MutedBySessionId");

                    b.Navigation("MutedBySession");
                });
